...
import DashboardTableProgressBar from './DashboardTableProgressBar';
...
class DashboardTableStatusBar extends PureComponent {
        ...
        return (
            ...
            <div className={classes.statusBarStyles} style={getStatusBarStyles(adjustedStatus)} >
                {adjustedStatus === "active" || adjustedStatus === "awaiting review" ? 
                    <DashboardTableProgressBar {...this.props} /> 
                : <span>
                    {adjustedStatus}...
                </span>}       
            </div>
...
export default withStyles(styles)(DashboardTableStatusBar)