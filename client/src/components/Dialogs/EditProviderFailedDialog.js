...
class EditProviderFailedDialog extends React.Component {
  state = {
    open: true
  };
    ...
    return (
      <div>
        ...
        >
            ...
            <DialogContent>
                <p>A problem was encountered and the providers's details were not updated.</p>
...
EditProviderFailedDialog.propTypes = {
  fullScreen: PropTypes.bool.isRequired,
};

export default withMobileDialog()(EditProviderFailedDialog);